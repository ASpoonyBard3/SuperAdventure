...
namespace Engine
{
    public static class World
    {
        ...
        public const int LOCATION_ID_MAKO_REACTOR = 10;
        ...
        private static void PopulateQuests()
        {
            ...
            clearAlchemistGarden.QuestCompletionItems.Add(new QuestCompletionItems(
            ...
            clearFarmersField.QuestCompletionItems.Add(new QuestCompletionItems(
