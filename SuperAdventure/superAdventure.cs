    ...
    public partial class SuperAdventure : Form
    {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.ItemRequiredToEnter != null)
            {
                ...
                {
                    // We didn't fnd the required item in their inventory,
                        ...
                        foreach (InventoryItem ii in _player.Inventory)
                            {
                                ...
                                if (ii.Details.ID == qci.Details.ID)
                                {
                                    ...
                                    // We found the item, so don't check
                                    // the rest of the player's inventory
                                break;
                                }
                            }

                            // If we didn't fnd the required item, set our variable and
                             ...
                             if (!foundItemInPlayersInventory)
                                {
                                    ...
                                    // There is no reason to continue checking for the other
